...
networkLevel="" # "Off", "Low", or "High"; if set "Off", script will not prompt and use "Low" for settings
...
cobaltstrikeDir="/root/cobaltstrike" # Cobaltstrike folder
c2profilesDir="/root/c2profiles" # Cobaltstrike C2 Profiles folder
veilDir="/root/veil" # Veil folder
empireDir="/root/powershellempire" # Empire folder
powersploitDir="/root/powersploit" # Powersploit folder
redteamShareAuth="0" # "0"=No user auth, "1"=Use user auth
redteamShareLow="" #e.g. 192.168.1.1 or share.com/remote.php/webdav/software where the Red Team software repo is located
redteamShareHigh="" #e.g. 192.168.1.1 or share.com/remote.php/webdav/software where the Red Team software repo is located
redteamShareUser="redteam" # Redteam share user
redteamSetipsServerAuth="0" # "0"=No user auth, "1"=Use user auth
redteamSetipsServerLow="" # Redteam wiki full web address
redteamSetipsServerHigh="" # Redteam wiki full web address
redteamSetipsServerUser="redteam" # Redteam wiki user
